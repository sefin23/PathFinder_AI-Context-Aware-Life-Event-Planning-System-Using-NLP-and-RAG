...
export default function AllBookmarkIcon({ size = 24, color = 'currentColor', ...props }) {
  return (
    <svg 
      ...
      {...props}
      role="img"
      aria-labelledby="bookmark-title bookmark-desc"
    >
      <title id="bookmark-title">Saved Items Icon</title>
      <desc id="bookmark-desc">An icon representing all saved event roadmaps and plans.</desc>
