...
- [x] **Layer 0: Orientation & Mental Model**
...
- [x] **Layer 3: NLP & RAG**
  - [x] Life-event classification (Gemini)
  - [x] Requirement retrieval (RAG)
  - [x] Workflow generation

- [x] **Layer 4: Adaptive Logic**
  - [x] Context-aware recommendations (Administrative vs Planning events)
  - [x] Dependency logic
